...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/LiveTranscriptionSession.swift:60`，`Sources/TranslaMicApp/Services/LiveTranscriptionSession.swift:241`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Models/OverlayStyle.swift:43`
- 说明：
...
- 结论：`不属实`
- 修复状态：`不适用`
- 位置：`Sources/TranslaMicApp/UI/Settings/SettingsWindowController.swift:25`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/UI/StatusBar/PopoverOutsideClickMonitor.swift`
- 说明：
...
- 结论：`不属实`
- 修复状态：`不适用`
- 位置：`Sources/TranslaMicApp/App/AppModel.swift:1178`，`Sources/TranslaMicApp/App/AppModel.swift:1850`
- 说明：
...
- 结论：`部分属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/SpeedMonitor.swift:19-24`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/EntityCache.swift:16-26`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/GlossaryService.swift:6-17`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/SileroVADEngine.swift:110`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/UI/Settings/TranscriptView.swift:215-228`
- 说明：
  - `Task { ... }` 没有保存句柄。
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Models/ModeConfig.swift:113-145`
- 说明：
...
- 结论：`部分属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/UI/Overlay/OverlayWindowController.swift:331`，`Sources/TranslaMicApp/UI/Overlay/OverlayWindowController.swift:403`，`Sources/TranslaMicApp/UI/Overlay/OverlayWindowController.swift:795`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/UI/Settings/SettingsView.swift:398-408`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/UI/Settings/SettingsWindowController.swift:26-57`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/SettingsStore.swift:17-24`
- 说明：
...
- 结论：`不属实`
- 修复状态：`不适用`
- 位置：`Sources/TranslaMicApp/UI/Settings/SettingsWindowController.swift:70`，`Sources/TranslaMicApp/UI/Settings/SettingsWindowController.swift:96`，`Sources/TranslaMicApp/UI/Settings/TranscriptView.swift:40`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/LiveTranscriptionSession.swift:1766`，`Sources/TranslaMicApp/Services/LiveTranscriptionSession.swift:2039`
- 说明：
...
- 结论：`不属实`
- 修复状态：`不适用`
- 位置：`Sources/TranslaMicApp/Services/LiveTranscriptionSession.swift:2317-2328`
- 说明：
...
- 结论：`部分属实`
- 修复状态：`[ ] 未修复`
- 位置：`Sources/TranslaMicApp/UI/Overlay/OverlayView.swift:620-638`
- 说明：
...
- 结论：`部分属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/UI/Overlay/OverlayWindowController.swift:794`
- 说明：
...
- 结论：`不属实`
- 修复状态：`不适用`
- 位置：`Sources/TranslaMicApp/UI/Settings/SettingsWindowController.swift`
- 说明：
...
- 结论：`不属实`
- 修复状态：`不适用`
- 位置：`Sources/TranslaMicApp/App/AppModel.swift`
- 说明：
...
- 结论：`部分属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/SileroVADHysteresis.swift`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/SettingsStore.swift`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/UI/Overlay/OverlayWindowController.swift`
- 说明：
...
- 结论：`部分属实`
- 修复状态：`[x] 已缓解`
- 位置：`Sources/TranslaMicApp/Services/SettingsStore.swift`，`Sources/TranslaMicApp/Models/AppSettings.swift`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/App/AppModel.swift`，`Sources/TranslaMicApp/UI/StatusBar/StatusBarPopoverView.swift`
- 说明：
...
- 结论：`属实`
- 修复状态：`[x] 已修复`
- 位置：`Sources/TranslaMicApp/Services/GlossaryService.swift`
- 说明：
