...
final class LiveTranscriptionSession: NSObject, @unchecked Sendable {
    ...
    private let captureQueue = DispatchQueue(label: "io.github.Techeek.TranslaMic.capture", qos: .userInitiated)
...
private final class ApplicationAudioCapture {
    ...
    func start() throws {
        do {
            ...
            tapDescription.name = "TranslaMic \(appName)"
            ...
            let aggregateDescription: [String: Any] = [
                kAudioAggregateDeviceNameKey: "TranslaMic-\(appName)",
